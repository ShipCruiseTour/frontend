    ...
    <form class="form-horizontal" enctype="multipart/form-data" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10 col-md-6">
                <input type="file" name="txt_file"
                    style="margin-bottom: 10px; width: 100%; background-color: #0000001a;padding: 10px;border-radius: 10px;box-shadow: 0 4px 4px black;" />
            </div>
        </div>
        <!-- End Tags image -->
        <!-- Start Submit Field -->
        <div class="form-group form-group-lg">
            <div class="col-sm-offset-2 col-sm-10">
                <input type="submit" value="Add Item" name="btn_insert" class="btn btn-primary btn-sm" />
            </div>
        </div>
        <!-- End Submit Field -->
    </form>
